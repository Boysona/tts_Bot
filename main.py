...
VOICE_MAPPING = {
    ...
    # ----- NEW VOICES ADDED (from your list) -----
    ...
    # French (France)
    "fr-FR-VivienneMultilingualNeural": "Vivienne - French (France) - Multilingual",  # already present but keep for safety
    "fr-FR-RemyMultilingualNeural": "Remy - French (France) - Multilingual",  # already present
    "fr-FR-LucienMultilingualNeural": "Lucien - French (France) - Multilingual",

    # German (Germany)
    "de-DE-SeraphinaMultilingualNeural": "Seraphina - German (Germany) - Multilingual",  # already present
    "de-DE-FlorianMultilingualNeural": "Florian - German (Germany) - Multilingual",  # already present
    ...
    "it-IT-GiuseppeMultilingualNeural": "Giuseppe - Italian (Italy) - Multilingual",  # already present
    ...
    "pt-BR-ThalitaMultilingualNeural": "Thalita - Portuguese (Brazil) - Multilingual",  # already present

    # Spanish (Mexico)
    "es-MX-DaliaMultilingualNeural": "Dalia - Spanish (Mexico) - Multilingual",  # already present as DaliaNeural; added multilingual variant
    "es-MX-JorgeMultilingualNeural": "Jorge - Spanish (Mexico) - Multilingual",    # already present as JorgeNeural

    # Spanish (Spain)
    "es-ES-ArabellaMultilingualNeural": "Arabella - Spanish (Spain) - Multilingual",

    # Chinese (Mandarin, Simplified)
    "zh-CN-XiaoxiaoMultilingualNeural": "Xiaoxiao - Chinese (Mandarin, Simplified) - Multilingual",  # already present as XiaoxiaoNeural
}
...
TTS_VOICES_BY_LANGUAGE = {
    ...
    "English": [
        ...
        # --- Added US/UK multilingual & turbo voices ---
        ...
        "en-US-EvelynMultilingualNeural","en-GB-AdaMultilingualNeural","en-GB-OllieMultilingualNeural"
    ],
