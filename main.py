...
# NOTE: HD voices use the combined shortname format required by edge-tts,
# e.g. "en-US-BrianDragonHDLatestNeural" (no colon)
VOICE_MAPPING = {
    ...
    "en-US-AndrewDragonHDLatestNeural": "Andrew - Dragon HD Latest (English, US)",
    "en-US-AvaDragonHDLatestNeural": "Ava - Dragon HD Latest (English, US)",
    "en-US-EmmaDragonHDLatestNeural": "Emma - Dragon HD Latest (English, US)",
    "en-US-AdamDragonHDLatestNeural": "Adam - Dragon HD Latest (English, US)",
    "en-US-Andrew2DragonHDLatestNeural": "Andrew2 - Dragon HD Latest (English, US)",
    "en-US-BrianDragonHDLatestNeural": "Brian - Dragon HD Latest (English, US)",
    "en-US-DavisDragonHDLatestNeural": "Davis - Dragon HD Latest (English, US)",
    "en-US-Emma2DragonHDLatestNeural": "Emma2 - Dragon HD Latest (English, US)",
    "en-US-SteffanDragonHDLatestNeural": "Steffan - Dragon HD Latest (English, US)",
    "en-US-AlloyDragonHDLatestNeural": "Alloy - Dragon HD Latest (English, US)",
    "en-US-Andrew3DragonHDLatestNeural": "Andrew3 - Dragon HD Latest (English, US)",
    "en-US-AriaDragonHDLatestNeural": "Aria - Dragon HD Latest (English, US)",
    "en-US-Ava3DragonHDLatestNeural": "Ava3 - Dragon HD Latest (English, US)",
    "en-US-BreeDragonHDLatestNeural": "Bree - Dragon HD Latest (English, US)",
    "en-US-PhoebeDragonHDLatestNeural": "Phoebe - Dragon HD Latest (English, US)",
    "en-US-SerenaDragonHDLatestNeural": "Serena - Dragon HD Latest (English, US)",
    # Other languages HD examples:
    "fr-FR-RemyDragonHDLatestNeural": "Remy - Dragon HD Latest (French, FR)",
    "fr-FR-VivienneDragonHDLatestNeural": "Vivienne - Dragon HD Latest (French, FR)",
    "de-DE-FlorianDragonHDLatestNeural": "Florian - Dragon HD Latest (German, DE)",
    "de-DE-SeraphinaDragonHDLatestNeural": "Seraphina - Dragon HD Latest (German, DE)",
    "ja-JP-MasaruDragonHDLatestNeural": "Masaru - Dragon HD Latest (Japanese, JP)",
    "ja-JP-NanamiDragonHDLatestNeural": "Nanami - Dragon HD Latest (Japanese, JP)",
    "zh-CN-XiaochenDragonHDLatestNeural": "Xiaochen - Dragon HD Latest (Chinese, CN)",
...
TTS_VOICES_BY_LANGUAGE = {
    ...
    "English": [
        ...
        # --- Add HD Latest English personas (combined shortname format) ---
        "en-US-AndrewDragonHDLatestNeural", "en-US-AvaDragonHDLatestNeural", "en-US-EmmaDragonHDLatestNeural",
        "en-US-AdamDragonHDLatestNeural", "en-US-BrianDragonHDLatestNeural", "en-US-DavisDragonHDLatestNeural",
        "en-US-AriaDragonHDLatestNeural", "en-US-PhoebeDragonHDLatestNeural", "en-US-SerenaDragonHDLatestNeural",
        # You can keep adding HD variants here...
    ],
    "French": ["fr-FR-RemyMultilingualNeural", "fr-FR-VivienneMultilingualNeural", "fr-FR-RemyDragonHDLatestNeural", "fr-FR-VivienneDragonHDLatestNeural"],
    "German": ["de-DE-FlorianMultilingualNeural", "de-DE-SeraphinaMultilingualNeural", "de-DE-FlorianDragonHDLatestNeural", "de-DE-SeraphinaDragonHDLatestNeural"],
    "Japanese": ["ja-JP-KeitaNeural", "ja-JP-NanamiNeural", "ja-JP-MasaruDragonHDLatestNeural", "ja-JP-NanamiDragonHDLatestNeural"],
    "Chinese": ["zh-CN-XiaoxiaoNeural", "zh-CN-XiaoyiNeural", "zh-CN-XiaochenDragonHDLatestNeural"],
...
async def synth_and_send_tts(chat_id: int, user_id: str, text: str):
    ...
    try:
        # Format pitch/rate for edge-tts
        pitch = f"{pitch_val}Hz" if pitch_val != 0 else "+0Hz"
        rate = f"+{rate_val}%" if rate_val >= 0 else f"{rate_val}%"
        # edge-tts.Communicate accepts the voice short name (combined format for HD voices)
