...
VOICE_MAPPING = {
    ...
    # --- NEW voices requested by user (added to VOICE_MAPPING only) ---
    # Multilingual / Turbo / Dragon HD Latest voices — display names include "Multilingual" so they'll appear in Auto.
    ...
    "en-US-AndrewDragonHDLatestMultilingualNeural": "Andrew - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-AvaDragonHDLatestMultilingualNeural": "Ava - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-EmmaDragonHDLatestMultilingualNeural": "Emma - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-BrianMultilingualNeural": "Brian - English (United States) - Multilingual",
    ...
    "en-US-AdamDragonHDLatestMultilingualNeural": "Adam - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-Andrew2DragonHDLatestMultilingualNeural": "Andrew2 - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-BrianDragonHDLatestMultilingualNeural": "Brian - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-DavisDragonHDLatestMultilingualNeural": "Davis - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-Emma2DragonHDLatestMultilingualNeural": "Emma2 - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-SteffanDragonHDLatestMultilingualNeural": "Steffan - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-AlloyDragonHDLatestMultilingualNeural": "Alloy - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-Andrew3DragonHDLatestMultilingualNeural": "Andrew3 - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-AriaDragonHDLatestMultilingualNeural": "Aria - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-Ava3DragonHDLatestMultilingualNeural": "Ava3 - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-BreeDragonHDLatestMultilingualNeural": "Bree - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-AvaAndAndrewMultiTalkerDragonHDLatestMultilingualNeural": "Ava & Andrew - MultiTalker - Dragon HD Latest - Multilingual",
    "en-US-AvaAndSteffanMultiTalkerDragonHDLatestMultilingualNeural": "Ava & Steffan - MultiTalker - Dragon HD Latest - Multilingual",
    "en-US-PhoebeDragonHDLatestMultilingualNeural": "Phoebe - English (United States) - Dragon HD Latest - Multilingual",
    "en-US-SerenaDragonHDLatestMultilingualNeural": "Serena - English (United States) - Dragon HD Latest - Multilingual",
    # Chinese multilingual / HD
    "zh-CN-XiaoxiaoMultilingualNeural": "Xiaoxiao - Chinese (Mandarin, Simplified) - Multilingual",
    "zh-CN-XiaochenDragonHDLatestMultilingualNeural": "Xiaochen - Chinese (Mandarin, Simplified) - Dragon HD Latest - Multilingual",
    # UK English
    ...
    # French
    "fr-FR-VivienneMultilingualLatestNeural": "Vivienne - French (France) - Multilingual (HD Latest)",
    "fr-FR-RemyMultilingualLatestNeural": "Remy - French (France) - Multilingual (HD Latest)",
    # German
    "de-DE-SeraphinaMultilingualLatestNeural": "Seraphina - German (Germany) - Multilingual (HD Latest)",
    "de-DE-FlorianMultilingualLatestNeural": "Florian - German (Germany) - Multilingual (HD Latest)",
    # Italian
    ...
    "it-IT-GiuseppeMultilingualLatestNeural": "Giuseppe - Italian (Italy) - Multilingual (HD Latest)",
    ...
    "ja-JP-MasaruDragonHDLatestMultilingualNeural": "Masaru - Japanese (Japan) - Dragon HD Latest - Multilingual",
    "ja-JP-NanamiDragonHDLatestMultilingualNeural": "Nanami - Japanese (Japan) - Dragon HD Latest - Multilingual",
    # Portuguese (Brazil)
    "pt-BR-MacerioMultilingualNeural": "Macerio - Portuguese (Brazil) - Multilingual",
    "pt-BR-ThalitaMultilingualLatestNeural": "Thalita - Portuguese (Brazil) - Multilingual (HD Latest)",
    # Spanish (Mexico / Spain)
    "es-MX-DaliaMultilingualLatestNeural": "Dalia - Spanish (Mexico) - Multilingual (HD Latest)",
...
TTS_VOICES_BY_LANGUAGE = {
    ...
    "French": ["fr-BE-CharlineNeural", "fr-BE-GerardNeural", "fr-CA-ThierryNeural", "fr-CA-AntoineNeural", "fr-CA-JeanNeural", "fr-CA-SylvieNeural", "fr-FR-VivienneMultilingualNeural", "fr-FR-RemyMultilingualNeural", "fr-FR-DeniseNeural", "fr-FR-EloiseNeural", "fr-FR-HenriNeural", "fr-CH-ArianeNeural", "fr-CH-FabriceNeural"],
...
# Get all multilingual voices (display name contains "Multilingual")
...
def make_initial_choice_keyboard():
    ...
    # Renamed buttons to be more descriptive as requested
    markup.add(
        InlineKeyboardButton("Auto (Multilingual & HD)", callback_data="choice|auto"),
        InlineKeyboardButton("By Language (Single-Language)", callback_data="choice|by_language")
    )
    return markup

def make_multilingual_voices_keyboard():
    markup = InlineKeyboardMarkup(row_width=2)
    # Sort multilingual voices by display name for nicer UI
    sorted_multis = sorted(MULTILINGUAL_VOICES, key=lambda v: VOICE_MAPPING.get(v, v).lower())
    for voice in sorted_multis:
...
def on_initial_choice(call):
    ...
    if choice == "auto":
        bot.edit_message_text(
            chat_id=chat_id,
            message_id=call.message.message_id,
            text="Choose a *multilingual or HD* voice: 👇",
